import{d as _,J as u,z as h,f as s,g as t,t as o,C as c,F as f,K as g,o as a,i as v,e as x,B as b}from"../modules/vue-CJQmjBDY.js";import{h as y,u as N,m}from"../index-dVSP-fN5.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-ru-mKNUK.js";import"../modules/shiki-DkXD3lZR.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
